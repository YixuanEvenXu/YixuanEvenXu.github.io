...
My research focuses on designing efficient and robust algorithms that improve real systems—across machine-learning pipelines and market-like mechanisms such as peer review. <!-- A notable example of my research is a [conference paper-reviewer assignment algorithm](https://arxiv.org/abs/2310.05995) that was deployed in NeurIPS 2024. --> See my <a href="{{ '/assets/pdf/CV.pdf' | relative_url }}">CV</a>, <a href="{{ '/publications/' | relative_url }}">publications</a> and [google scholar](https://scholar.google.com/citations?user=viloxoAAAAAJ) for more details about the projects I have done.
